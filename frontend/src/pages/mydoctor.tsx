...
export const MyDoctor = (): JSX.Element => {
  ...
  const getFile = async () => {
    try {
      ...
      const doctorFile = await MedicalRecordsContract.getModifiedFileFromDoctor(
        // "0x1e6d684046f7d99f78639562bB17d53d3CEFc937",
        userAddress,
        selectedPat
        // "0x1606Fdaef5Ca1620877775B0C6077Ca83260c047"
  ...
  const getList = async () => {
    try {
      const patCount = await MedicalRecordsContract.docterCount();

      for (let i = 0; i < patCount; i++) {
        const patientListAdd = await MedicalRecordsContract.docterList(i);
    ...
    <Box display="flex">
      ...
      <Box marginLeft="310px" marginTop="20px">
        ...
        <Typography
          ...
          marginTop="20px"
        >
          Step 3: Download new medical record for you
        </Typography>
